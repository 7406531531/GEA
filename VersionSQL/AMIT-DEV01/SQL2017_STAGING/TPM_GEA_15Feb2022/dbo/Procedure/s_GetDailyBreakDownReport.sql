...
END
---mod 4
select @strsql='insert into  #TempBreakDownData(StartTime,endtime,machineid,machineDescription,componentid,OperationNo,OperatorID,OperatorName,downid,downdescription,downtime,Mcdowntime,remarks,id,StdSetup,SetupEff)
select
A.sttime,A.ndtime,
