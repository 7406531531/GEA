...
-- [dbo].[util_RenameMachineName] '841450','841450-C1'
...
--	ALTER TABLE EfficiencyTarget NOCHECK CONSTRAINT FK_EfficiencyTarget_machineinformation
	...
	IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='dbo' AND TABLE_NAME='EfficiencyTarget')
	BEGIN
	SET @ErrorStep = 'Error in updating  EfficiencyTarget(Check constraints)';	
	ALTER TABLE EfficiencyTarget WITH CHECK CHECK CONSTRAINT FK_EfficiencyTarget_machineinformation
	ALTER TABLE EfficiencyTarget WITH CHECK CHECK CONSTRAINT FK_EfficiencyTarget_machineinformation
	END
	...
	IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='dbo' AND TABLE_NAME='FinalInspectionTransaction_GEA')
	BEGIN
	SET @ErrorStep = 'Error in updating FinalInspectionTransaction_GEA'
	UPDATE FinalInspectionTransaction_GEA SET MachineID=@MachineIDNew WHERE MachineID=@MachineIDOld
	SET @update_count = @@ROWCOUNT
	print 'Updated ' + CONVERT(varchar, @update_count) + ' records in table FinalInspectionTransaction_GEA'
	END

	IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='dbo' AND TABLE_NAME='InspectionTransaction_GEA')
	BEGIN
	SET @ErrorStep = 'Error in updating InspectionTransaction_GEA'
	UPDATE InspectionTransaction_GEA SET MachineID=@MachineIDNew WHERE MachineID=@MachineIDOld
	SET @update_count = @@ROWCOUNT
	print 'Updated ' + CONVERT(varchar, @update_count) + ' records in table InspectionTransaction_GEA'
	END

	IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='dbo' AND TABLE_NAME='NonMachiningEvents_GEA')
	BEGIN
	SET @ErrorStep = 'Error in updating NonMachiningEvents_GEA'
	UPDATE NonMachiningEvents_GEA SET Machineid=@MachineIDNew WHERE Machineid=@MachineIDOld
	SET @update_count = @@ROWCOUNT
	print 'Updated ' + CONVERT(varchar, @update_count) + ' records in table NonMachiningEvents_GEA'
	END

	IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='dbo' AND TABLE_NAME='ParkedScheduleDetails_GEA')
	BEGIN
	SET @ErrorStep = 'Error in updating ParkedScheduleDetails_GEA'
	UPDATE ParkedScheduleDetails_GEA SET Machineid=@MachineIDNew WHERE Machineid=@MachineIDOld
	SET @update_count = @@ROWCOUNT
	print 'Updated ' + CONVERT(varchar, @update_count) + ' records in table ParkedScheduleDetails_GEA'
	END

	IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='dbo' AND TABLE_NAME='QualityTransaction_GEA')
	BEGIN
	SET @ErrorStep = 'Error in updating QualityTransaction_GEA'
	UPDATE QualityTransaction_GEA SET MachineID=@MachineIDNew WHERE MachineID=@MachineIDOld
	SET @update_count = @@ROWCOUNT
	print 'Updated ' + CONVERT(varchar, @update_count) + ' records in table QualityTransaction_GEA'
	END

	IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='dbo' AND TABLE_NAME='RunningScheduleDetails_GEA')
	BEGIN
	SET @ErrorStep = 'Error in updating RunningScheduleDetails_GEA'
	UPDATE RunningScheduleDetails_GEA SET Machineid=@MachineIDNew WHERE Machineid=@MachineIDOld
	SET @update_count = @@ROWCOUNT
	print 'Updated ' + CONVERT(varchar, @update_count) + ' records in table RunningScheduleDetails_GEA'
	END

	IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='dbo' AND TABLE_NAME='ScheduleCalculateMethod_GEA')
	BEGIN
	SET @ErrorStep = 'Error in updating ScheduleCalculateMethod_GEA'
	UPDATE ScheduleCalculateMethod_GEA SET Machineid=@MachineIDNew WHERE Machineid=@MachineIDOld
	SET @update_count = @@ROWCOUNT
	print 'Updated ' + CONVERT(varchar, @update_count) + ' records in table ScheduleCalculateMethod_GEA'
	END

	IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='dbo' AND TABLE_NAME='ScheduleDetails_GEA')
	BEGIN
	SET @ErrorStep = 'Error in updating ScheduleDetails_GEA'
	UPDATE ScheduleDetails_GEA SET Machineid=@MachineIDNew WHERE Machineid=@MachineIDOld
	SET @update_count = @@ROWCOUNT
	print 'Updated ' + CONVERT(varchar, @update_count) + ' records in table ScheduleDetails_GEA'
	END

	IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='dbo' AND TABLE_NAME='ActivityMaster_MGTL')
	BEGIN
	SET @ErrorStep = 'Error in updating ActivityMaster_MGTL'
	UPDATE ActivityMaster_MGTL SET MachineID=@MachineIDNew WHERE MachineID=@MachineIDOld
	SET @update_count = @@ROWCOUNT
	print 'Updated ' + CONVERT(varchar, @update_count) + ' records in table ActivityMaster_MGTL'
	END

	IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='dbo' AND TABLE_NAME='ActivityMasterYearlyData_MGTL')
	BEGIN
	SET @ErrorStep = 'Error in updating ActivityMasterYearlyData_MGTL'
	UPDATE ActivityMasterYearlyData_MGTL SET MachineID=@MachineIDNew WHERE MachineID=@MachineIDOld
	SET @update_count = @@ROWCOUNT
	print 'Updated ' + CONVERT(varchar, @update_count) + ' records in table ActivityMasterYearlyData_MGTL'
	END

	IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='dbo' AND TABLE_NAME='ActivityTransaction_MGTL')
	BEGIN
	SET @ErrorStep = 'Error in updating ActivityTransaction_MGTL'
	UPDATE ActivityTransaction_MGTL SET MachineID=@MachineIDNew WHERE MachineID=@MachineIDOld
	SET @update_count = @@ROWCOUNT
	print 'Updated ' + CONVERT(varchar, @update_count) + ' records in table ActivityTransaction_MGTL'
	END
