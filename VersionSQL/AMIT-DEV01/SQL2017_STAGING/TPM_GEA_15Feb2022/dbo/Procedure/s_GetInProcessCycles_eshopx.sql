...
(
	...
	Mode int, --ER0350
	Partscount decimal(18,3), --GEA
	WorkorderNumber nvarchar(50) --GEA
)
...
Insert into #Inprocesscycles(sttime,ndtime,mc,comp,opn,opr,[id],datatype,WorkorderNumber) --GEA
select top 1 sttime,@endtime,mc,comp,opn,opr,slno,'11',WorkorderNumber from rawdata
...
select ComponentID,description,OperationNo,OperatorID,OperatorName,sttime,ndtime,CycleTime,mc,comp,opn,PDT,LoadUnloadTime,Remarks,StdCycleTime,StdMachiningTime,id,In_Cycle_DownTime,stdmctime,stdlLoadUnloadTime,0,0,WorkorderNumber from #Temp --ER0350
where datatype=11
