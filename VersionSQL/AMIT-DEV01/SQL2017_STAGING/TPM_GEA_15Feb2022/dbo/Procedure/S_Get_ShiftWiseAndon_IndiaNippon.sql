...
exec [S_Get_ShiftWiseAndon_IndiaNippon] @StartTime=N'2021-08-13 06:30:00',@EndTime=N'2021-08-13 15:00:00',@GroupID=N'CNC CELL',@Param=N'MachineWise'
*/
...
--SET @CurrTime =	'2021-08-13 12:35:00'		
print @CurrTime
...
SET
	...
	/*Shift Target Calculation*/
		...
		from (
		select distinct MachineID,Target from #ShiftFinalTarget
