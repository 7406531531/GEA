/****** Object:  Procedure [dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels]    Committed by VersionSQL https://www.versionsql.com ******/
...
--[dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels] '2018-11-01','','','','','','YEAR','OEE','','MachineId','','Machine'        
--[dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels] '2018-11-01','','','','','','YEAR','OEE','','ComponentID','','Component'        
--[dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels] '2018-11-01','','','','','','YEAR','OEE','','OperatorID','','Operator' 
--[dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels] '2018-11-01','','','','','','YEAR','OEE','','PlantID','','Plant' 
        
--[dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels] '2018-11-01','','','','','','MONTH','AE','','NameOftheMonth','','Machine'       
--[dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels] '2018-11-01','','','','','','MONTH','PE','','NameOftheMonth','','Component'          
--[dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels] '2018-11-01','','','','','','MONTH','QE','','NameOftheMonth','','Operator'   
--[dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels] '2018-11-01','','','','','','MONTH','AcceptedParts','','NameOftheMonth','','Plant'   
    
--[dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels] '2018-11-01','','','','','','DAY','RejCount','','Day','','Machine'       
--[dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels] '2018-11-01','','','','','','DAY','ReworkPerformed','','Day','','Component'          
--[dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels] '2018-11-01','','','','','','DAY','OEE','','Day','','Operator'   
--[dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels] '2018-11-01','','','','','','DAY','DownTime','','Day','','Plant'         
     
--[dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels] '2018-11-01','','','','','','Shift','OEE','','Parameter','','Machine'       
--[dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels] '2018-11-01','','','','','','Shift','OEE','','Parameter','','Component'  
-- [dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels] '2018-11-01','','','','AG1460','','Shift','OEE','','Parameter','','Component'        
--[dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels] '2018-11-01','','','','','','Shift','OEE','','Parameter','','Operator'   
--[dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels] '2018-11-01','','','','','70100032','Shift','OEE','','Parameter','','Operator'
--[dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels] '2018-11-01','','','','','','Shift','OEE','','Parameter','','Plant' 
****************************************************************************************************/        
CREATE  PROCEDURE [dbo].[s_GetAggDrilldownTPMTrakData_Graph_Wheels]        
...
BEGIN
 ...
 Select @Strsql = @Strsql+@StrComponent +' )' 
...
BEGIN  
 ...
 Select @Strsql = @Strsql+  @StrPlantID + @Strmachine + @StrShift + @StrComponent + @StrEmployee        
...
---mod 1 introduced with mod2 to neglect threshold ML from dtime        
 ...
 When '''+@Parameter+'''=''DownTime'' then Round(dbo.f_FormatTime(DownTime,'''+@timeformat+'''),2)       
