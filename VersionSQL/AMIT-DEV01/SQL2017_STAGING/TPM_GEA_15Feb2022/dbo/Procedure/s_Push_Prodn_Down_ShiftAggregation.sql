...
--s_Push_Prodn_Down_ShiftAggregation  '2019-03-15'   , '' ,'' ,'','PUSH','','9999-03-01'
...
--Declare @strMachine as varchar(2000) --DR0302 Added --pMT
Declare @strMachine as nvarchar(max) --DR0302 Added --pMT
Declare @strtemp as varchar(1000) --DR0302 Added 

Declare @strPlantID as nvarchar(250)
--Declare @StrSql as nvarchar(4000) --DR0302 Commented
--Declare @StrSql as varchar(8000) --DR0302 Added
Declare @StrSql as nvarchar(max) --DR0302 Added --PMT
---mod 11
Declare @Qparam1 as nvarchar(500)
Declare @Qparam2 as nvarchar(500)
Declare @Rejection as nvarchar(4000)
--mod 11
...
,FormatedWONumber,GroupID,Finishedoperation)' --ER0349 added New Column --GNA
--DR0272 Till Here
---mod 7
...
---mod 7
SELECT @StrSql= @StrSql+',A.WorkOrderNumber,PlantMachineGroups.GroupID,componentoperationpricing.Finishedoperation ' --ER0349 Added --GNA
SELECT @StrSql= @StrSql
...
---mod 7
SELECT @StrSql = @StrSql + ',A.WorkOrderNumber,machineinformation.MachinewiseOwner ,machineinformation.CriticalMachineEnabled,PlantMachineGroups.GroupID,componentoperationpricing.Finishedoperation '--geeta added --GNA
---mod 7
print @StrSql
Exec (@StrSql)
...
Price,SubOperation,LastAggrStart,Minterface,Cinterface ,Opninterface ,OprInterface,WorkOrderNumber,
MachinewiseOwner ,CriticalMachineEnabled --geeta added
,FormatedWONumber,GroupID,Finishedoperation)' --ER0349 Added New column
--DR0272 Till Here
---mod 7
SELECT @StrSql= @StrSql
+ ' SELECT T.Mdate,T.Mshift,T.MShiftStart,T.MShiftEnd,PlantMachine.PlantID,T.Amachine,
...
SELECT @StrSql= @StrSql
+ ' ,PlantMachineGroups.GroupID,componentoperationpricing.Finishedoperation  --GNA
FROM #T_autodata A ---ER0202 
INNER JOIN EmployeeInformation ON A.Opr=EmployeeInformation.InterfaceID
INNER JOIN machineinformation ON A.mc = machineinformation.InterfaceID
inner join #TempMCOODown T on T.Amachine=machineinformation.Machineid
...
---mod 7
SELECT @StrSql = @StrSql + ',PlantInformation.Plantcode,PlantMachineGroups.GroupID,componentoperationpricing.Finishedoperation' --ER0349 Added  --Added Groupid For GNA
print @StrSql
Exec (@StrSql)
...
update shiftproductiondetails set Prod_Qty=Prod_Qty+T1.Prod ,
AcceptedParts=AcceptedParts+T1.Accept,
Dummy_Cycles=Dummy_Cycles+T1.dummyCyc,
Sum_of_ActCycleTime=Sum_of_ActCycleTime+T1.SumAct,
ActMachiningTime_Type12=ActMachiningTime_Type12+T1.ActMAc,
ActLoadUnload_Type12=ActLoadUnload_Type12+T1.ActLoad,
MaxMachiningTime=T1.Maxmac,
MinMachiningTime=T1.MinMac,
MaxLoadUnloadTime=T1.MaxLoad,
MinLoadUnloadTime=T1.MinLoad,
...
else T.MinLoadUnloadTime end as MinLoad,T.PDT,T.Finishedoperation from #TempShiftProductionDetails T
...
---mod 7
,MachinewiseOwner ,CriticalMachineEnabled,GroupID,PDT,Finishedoperation)--geeta added --GNA
...
---mod 7
,MachinewiseOwner,CriticalMachineEnabled --geeta added
,GroupID,PDT,Finishedoperation --GNA
...
Declare @Param1 As nVarChar(max) --PMT
...
--SELECT @Param1=@Param1 + @StrPlantID + @strmachine + @StrPLD_DownId
 --SELECT @Param1=@Param1 + convert(varchar(1000),@StrPlantID) + convert(varchar(1000),@strmachine) + convert(varchar(1000),@StrPLD_DownId)+ convert(varchar(1000),@StrGroupID) --GNA --PMT
 SELECT @Param1=@Param1 + convert(nvarchar(1000),@StrPlantID) + convert(nvarchar(max),@strmachine) + convert(nvarchar(1000),@StrPLD_DownId)+ convert(nvarchar(1000),@StrGroupID) --GNA --PMT
--DR0302 till here
...
If @Param2<>'' 
Begin
SELECT @StrSql=@StrSql + convert(varchar(1000),@Param2) 
END
--DR0302 till here
---mod 11
...
---mod 7
SELECT @StrSql = @StrSql + ',M.CriticalMachineEnabled,PlantMachineGroups.Groupid'
---DR0302 from here
If @Param2<>'' 
Begin 
...
--SELECT @StrSql=@StrSql + convert(varchar(4000),@Param1) --PMT
If @Param1<>'' 
Begin
SELECT @StrSql=@StrSql + convert(nvarchar(max),@Param1) --PMT
END
--DR0302 till here
---mod 11
--DR0302 from here
...
OR(StTime>=T.MShiftStart And StTime<T.MShiftEnd And ndTime>T.MShiftEnd)
OR(StTime<T.MShiftStart And ndTime>T.MShiftEnd)) '
SELECT @StrSql=@StrSql +  convert(varchar(500),@strtemp) 
...
--SELECT @StrSql = @StrSql+convert(varchar(1000),@Param3) --Commented because when NetDowntime=0 then show the time in PDT Column.
--DR0302 till here
---mod 11
...
Select convert(nvarchar(10),#ShiftDetails.pdate,120),#ShiftDetails.Shift,machineinformation.Machineid,machineinformation.Interfaceid,
componentinformation.Componentid,componentinformation.Interfaceid,componentoperationpricing.Operationno,
componentoperationpricing.Interfaceid,EmployeeInformation.Employeeid,EmployeeInformation.Interfaceid,
...
Insert into #TempShiftRejection(SR_Pdate,SR_Shift,SP_Machineid,SR_Mach_interface,Sp_Componentid,SR_Comp_interface,Sp_Opn,SR_Operation_interface,Sp_Oprtor,SR_Oprtor_interface,
Rejectionreason,RejectionQty,SDTimestamp,Recordid,WorkOrderNumber) 
 Select convert(nvarchar(10),AutodataRejections.Rejdate,120),#ShiftDetails.Shift,machineinformation.Machineid,machineinformation.Interfaceid,
componentinformation.Componentid,componentinformation.Interfaceid,componentoperationpricing.Operationno,
componentoperationpricing.Interfaceid,EmployeeInformation.Employeeid,EmployeeInformation.Interfaceid,
rejectioncodeinformation.Rejectionid,AutodataRejections.Rejection_Qty,AutodataRejections.CreatedTS,AutodataRejections.Recordid,AutodataRejections.WorkOrderNumber 
...
SPD.OperatorID=SRD.Sp_Oprtor and convert(nvarchar(10),SPD.pdate,120)=convert(nvarchar(10),SRD.SR_Pdate,120) and SPD.shift=SRD.SR_Shift
...
(
	...
	SPD.PA_OperatorID=SRD.Sp_Oprtor and convert(nvarchar(10),SPD.PA_date,120)=convert(nvarchar(10),SRD.SR_Pdate,120) and SPD.PA_Shift=SRD.SR_Shift and SPD.PA_WorkOrderNumber=SRD.WorkOrderNumber
	Group by SRD.SP_Machineid,SRD.Sp_Componentid,SRD.Sp_Opn,SRD.Sp_Oprtor,SRD.SR_Pdate,SRD.SR_Shift,SRD.WorkOrderNumber
)SRD
inner join #TempProdAccepted SPD on SPD.PA_MachineID= SRD.SP_Machineid and SPD.PA_ComponentID=SRD.Sp_Componentid and SPD.PA_OperationNo=SRD.Sp_Opn and
SPD.PA_OperatorID=SRD.Sp_Oprtor and convert(nvarchar(10),SPD.PA_date,120)=convert(nvarchar(10),SRD.SR_Pdate,120) and SPD.PA_Shift=SRD.SR_Shift and SPD.PA_WorkOrderNumber=SRD.WorkOrderNumber --where (SPD.PA_Accepted<>0 and SPD.PA_Accepted>=SRd.Rejqty)
...
inner join #TempProdAccepted SPD on SPD.PA_MachineID= SRD.SP_Machineid
and SPD.PA_ComponentID=SRD.Sp_Componentid and SPD.PA_OperationNo=SRD.Sp_Opn and
SPD.PA_OperatorID=SRD.Sp_Oprtor and convert(nvarchar(10),SPD.PA_date,120)=convert(nvarchar(10),SRD.SR_Pdate,120) and SPD.PA_Shift=SRD.SR_Shift and SPD.PA_WorkOrderNumber=SRD.WorkOrderNumber--where (SPD.PA_Accepted<>0 and SPD.PA_Accepted>SRD.RejectionQty)
...
T1.Sp_Oprtor=SRD.Sp_Oprtor and convert(nvarchar(10),T1.SR_Pdate,120)=convert(nvarchar(10),SRD.SR_Pdate,120) and T1.SR_Shift=SRD.SR_Shift and T1.WorkOrderNumber=SRD.WorkOrderNumber
...
Reworkreason,ReworkQty,SDTimestamp,Recordid,WorkOrderNumber) 
Select convert(nvarchar(10),#ShiftDetails.pdate,120),#ShiftDetails.Shift,machineinformation.Machineid,machineinformation.Interfaceid,
componentinformation.Componentid,componentinformation.Interfaceid,componentoperationpricing.Operationno,
componentoperationpricing.Interfaceid,EmployeeInformation.Employeeid,EmployeeInformation.Interfaceid,
...
and SPD.ComponentID=SRD.Sp_Componentid and SPD.OperationNo=SRD.Sp_Opn and
SPD.OperatorID=SRD.Sp_Oprtor and convert(nvarchar(10),SPD.pdate,120)=convert(nvarchar(10),SRD.SR_Pdate,120) and SPD.shift=SRD.SR_Shift and SPD.workordernumber=SRD.workordernumber
order by SPD.id'
exec(@strsql)
...
(
	...
	SPD.PA_OperatorID=SRD.Sp_Oprtor and convert(nvarchar(10),SPD.PA_date,120)=convert(nvarchar(10),SRD.SR_Pdate,120) and SPD.PA_Shift=SRD.SR_Shift
	Group by SRD.SP_Machineid,SRD.Sp_Componentid,SRD.Sp_Opn,SRD.Sp_Oprtor,SRD.SR_Pdate,SRD.SR_Shift,SRD.WorkOrderNumber
)SRD
inner join #TempProdAccepted1 SPD on SPD.PA_MachineID= SRD.SP_Machineid
and SPD.PA_ComponentID=SRD.Sp_Componentid and SPD.PA_OperationNo=SRD.Sp_Opn and
SPD.PA_OperatorID=SRD.Sp_Oprtor and convert(nvarchar(10),SPD.PA_date,120)=convert(nvarchar(10),SRD.SR_Pdate,120) and SPD.PA_Shift=SRD.SR_Shift and SPD.PA_WorkOrderNumber=SRD.WorkOrderNumber --where (SPD.PA_Accepted<>0 and SPD.PA_Accepted>=SRd.Rewqty)
