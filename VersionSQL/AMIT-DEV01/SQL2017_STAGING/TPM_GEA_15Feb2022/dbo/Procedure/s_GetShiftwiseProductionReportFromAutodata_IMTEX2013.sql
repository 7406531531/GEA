...
exec [s_GetShiftwiseProductionReportFromAutodata_IMTEX2013] '2020-06-01 06:00:00','','CNC-01','','','','2020-06-06 06:00:00','Fortablet'  
...
---------------------------------by Mrudula for optimization------------------------------------  
  ...
  BEGIN  
   ...
   UPDATE #ShiftProductionFromAutodataT2 SET OperationCount=ISNULL(OperationCount,0)- isnull(t2.PlanCt,0)  
	...
	--(CEILING (CAST(Sum(ISNULL(PartsCount,1)) AS Float)/ISNULL(Componentoperationpricing.SubOperations,1))) as PlanCt,  
...
From      
( Select S.ShftStart,A.mc,A.comp,A.opn,A.opr,SUM(A.Rejection_Qty) as RejQty,A.WorkOrderNumber from AutodataRejections A      
inner join #ShiftProductionFromAutodataT2 S on S.MachineInterface=A.mc and S.CompInterface=A.comp and S.OPNInterface=A.opn and S.OprInterface=A.opr and S.WorkOrderNumber=A.WorkOrderNumber
...
group by S.ShftStart,A.mc,A.comp,A.opn,A.opr,A.WorkOrderNumber     
...
T2.opn = #ShiftProductionFromAutodataT2.OPNInterface and T2.opr = #ShiftProductionFromAutodataT2.OprInterface and T2.ShftStart=#ShiftProductionFromAutodataT2.ShftStart and T2.WorkOrderNumber=#ShiftProductionFromAutodataT2.WorkOrderNumber  
...
BEGIN      
 ...
 group by S.ShftStart,A.mc,A.comp,A.opn,A.opr,A.WorkOrderNumber)T2 inner join #ShiftProductionFromAutodataT2 ON T2.mc = #ShiftProductionFromAutodataT2.MachineInterface and T2.comp = #ShiftProductionFromAutodataT2.CompInterface and T2.opn = #ShiftProductionFromAutodataT2.OPNInterface 
and T2.ShftStart=#ShiftProductionFromAutodataT2.ShftStart and T2.opr = #ShiftProductionFromAutodataT2.OprInterface and T2.WorkOrderNumber=#ShiftProductionFromAutodataT2.WorkOrderNumber   
END     
...
and T2.WorkOrderNumber=#ShiftProductionFromAutodataT2.WorkOrderNumber  
...
From      
( Select S.ShftStart,A.mc,A.comp,A.opn,A.opr,SUM(A.Rejection_Qty) as RewQty,A.WorkOrderNumber from AutodataRejections A      
inner join #ShiftProductionFromAutodataT2 S on S.MachineInterface=A.mc and S.CompInterface=A.comp and S.OPNInterface=A.opn and S.OprInterface=A.opr and S.WorkOrderNumber=A.WorkOrderNumber
