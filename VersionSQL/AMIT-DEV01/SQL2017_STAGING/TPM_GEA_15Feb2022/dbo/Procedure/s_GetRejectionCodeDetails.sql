...
Select @strsql = @strsql + ' Group by A.RejDate,A.RejShift,M.machineid,C.Componentid,O.Operationno,E.Employeeid,E.Name, R.Catagory,R.rejectionid,A.RejectionType'
print @strsql
Exec(@strsql)
...
Select @strsql = @strsql + @strPlantID + @strMachine  + @strComponent
Select @strsql = @strsql + ' Group by #shift.ShiftDate, #shift.shiftid,M.machineid,C.Componentid,O.Operationno, E.Employeeid,E.Name, R.Catagory,R.rejectionid,AutodataRejections.RejectionType'
print @strsql
Exec(@strsql)
