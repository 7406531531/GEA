...
ALTER TABLE [dbo].[componentoperationpricing] ADD  CONSTRAINT [DF__component__SubOp__2F10007B]  DEFAULT ((1)) FOR [SubOperations]
...
ALTER TABLE [dbo].[componentoperationpricing] ADD  CONSTRAINT [DF__component__Updat__31EC6D26]  DEFAULT ('pct') FOR [UpdatedBy]
ALTER TABLE [dbo].[componentoperationpricing] ADD  CONSTRAINT [DF__component__Updat__32E0915F]  DEFAULT (getdate()) FOR [UpdatedTS]
ALTER TABLE [dbo].[componentoperationpricing] ADD  CONSTRAINT [DF__component__Lower__33D4B598]  DEFAULT ((0)) FOR [LowerEnergyThreshold]
ALTER TABLE [dbo].[componentoperationpricing] ADD  CONSTRAINT [DF__component__Upper__34C8D9D1]  DEFAULT ((0)) FOR [UpperEnergyThreshold]
ALTER TABLE [dbo].[componentoperationpricing] ADD  CONSTRAINT [DF__component__StdDi__35BCFE0A]  DEFAULT ((0)) FOR [StdDieCloseTime]
ALTER TABLE [dbo].[componentoperationpricing] ADD  CONSTRAINT [DF__component__StdPo__36B12243]  DEFAULT ((0)) FOR [StdPouringTime]
ALTER TABLE [dbo].[componentoperationpricing] ADD  CONSTRAINT [DF__component__StdSo__37A5467C]  DEFAULT ((0)) FOR [StdSolidificationTime]
ALTER TABLE [dbo].[componentoperationpricing] ADD  CONSTRAINT [DF__component__StdDi__38996AB5]  DEFAULT ((0)) FOR [StdDieOpenTime]
ALTER TABLE [dbo].[componentoperationpricing] ADD  CONSTRAINT [DF__component__Palle__149C0161]  DEFAULT ((0)) FOR [PalletCount]
ALTER TABLE [dbo].[componentoperationpricing] ADD  CONSTRAINT [DF__component__Finis__43B6E2FD]  DEFAULT ((0)) FOR [FinishedOperation]
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
