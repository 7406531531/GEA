/****** Object:  Table [dbo].[NoiseMeasurementTransaction_GEA]    Committed by VersionSQL https://www.versionsql.com ******/
...
CREATE TABLE [dbo].[NoiseMeasurementTransaction_GEA](
...
ALTER TABLE [dbo].[NoiseMeasurementTransaction_GEA] ADD  DEFAULT ((0)) FOR [Confirmation]