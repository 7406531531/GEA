/****** Object:  Table [dbo].[ElectrotechnicalTransaction_GEA]    Committed by VersionSQL https://www.versionsql.com ******/
...
CREATE TABLE [dbo].[ElectrotechnicalTransaction_GEA](
...
ALTER TABLE [dbo].[ElectrotechnicalTransaction_GEA] ADD  DEFAULT ((0)) FOR [Confirmation]