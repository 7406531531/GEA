/****** Object:  Table [dbo].[Focas_ToolLifeTemp]    Committed by VersionSQL https://www.versionsql.com ******/
...
CREATE TABLE [dbo].[Focas_ToolLifeTemp](
 ...
 CONSTRAINT [PK_Focas_ToolActTrg1] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
